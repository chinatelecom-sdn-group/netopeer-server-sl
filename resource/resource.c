...
xmlDocPtr get_state_data ( xmlDocPtr model, xmlDocPtr running, struct nc_err **err )
{
	...
	return ( get_ResourceInfo() );
}
/*
 * Mapping prefixes with namespaces.
 * Do NOT modify this structure!
 */
struct ns_pair namespace_mapping[] = {{"resource", "http://www.gsta.com/resource"}, {NULL, NULL}};
...
/**
 * @brief This callback will be run when node in path /resource:resource changes
 *
...
int callback_resource_resource ( void ** data, XMLDIFF_OP op, xmlNodePtr node, struct nc_err** error )
{
    return EXIT_SUCCESS;
}
...
struct transapi_data_callbacks clbks =  {
    ...
    .data = NULL,
    .callbacks = {
        {.path = "/resource:resource", .func = callback_resource_resource}
    }
};
